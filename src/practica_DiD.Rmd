...
```
De acuerdo con el *p-value* del estadístico *F* no podemos rechazar la hipótesis nula. Es decir, no podemos afirmar que la diferencia en el número de empleados NJ antes y después del aumento del salrio mínimo es significativo. 
...
Con el objetivo de obtener estimaciones más precisas, hacemos una mejor especificación del modelo incorporando controles al modelo, siguiendo lo establecido por Card y Krueger (1994).
